...
if (!isset($_SESSION['user_id']) || !in_array($_SESSION['user_type'], ['scholarship_coordinator', 'admin'])) {
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <div class="nav-section">
                    ...
                    <ul>
                        <li><a href="scholarship_coordinator.php" class="nav-link active" data-section="dashboard" title="Dashboard">
