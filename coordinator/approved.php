...
// Build the SQL query with filters - Removed approved_by join, using reviewed_by instead
$sql = "SELECT 
    sa.application_id,
    sa.application_date,
    sa.semester,
...
$semesters_query = "SELECT DISTINCT semester FROM scholarship_applications WHERE application_status = 'approved' ORDER BY semester";
...
<body class="theme-dark">
    ...
    <div class="dashboard-container">
            ...
            <nav class="sidebar-nav">
                <div class="nav-section">
                    ...
                    <ul>
                        ...
                        <li><a href="approved.php" class="nav-link active" data-section="scholarship-application" title="Scholarship">
        ...
        <main class="main-content">
            ...
            <section id="approved-scholarships" class="content-section active">
                <div class="section-header">
                    <h1>Approved Scholarships</h1>
                </div>
                ...
                <div class="filters-container">
                    <form method="GET" action="approved.php">
                        ...
                        <div class="filter-actions">
                            <button type="button" class="btn-reset" onclick="window.location.href='approved.php'">Reset</button>
                            ...
                            <?php if($result && $result->num_rows > 0): ?>
                                <?php while($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="archive_process.php?id=<?php echo $row['application_id']; ?>" 
                                            class="btn-archive"
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="13" class="no-data">
                                        <p>No approved scholarship applications found.</p>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
